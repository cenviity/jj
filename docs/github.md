...
You only need to create a branch when you need to push the stack to a
...
# Update the branch to point to the parent commit
...
local branches. This means that if you want to iterate on or test another
...
merged through a pull request, while "origin" is your fork of the
