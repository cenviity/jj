...
* `author_timestamp(pattern)`: Commits with [author
  timestamps](glossary.md#author-date) matching the specified [date
...
* `committer_timestamp(pattern)`: Commits with [committer
  timestamps](glossary.md#committer-timestamp) matching the specified [date
  pattern](#date-patterns).
