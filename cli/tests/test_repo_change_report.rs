...
fn test_report_conflicts_with_resolving_conflicts_hint_disabled() {
    ...
    ------- stderr -------
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln 26b9e38d (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 93098e65 (conflict) 3
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz 93098e65 (conflict) 3
      rlvkpnrz c90a55b5 (conflict) 2
    [EOF]
    ");
